        ...
        return (
          ...
          >
            ...
            <div className="mkt-card-caption">
              <h2 className="font-display text-[clamp(1.45rem,6.8vw,2.1rem)] leading-[0.95] text-cream drop-shadow-[0_1px_12px_rgba(0,0,0,0.45)] md:text-[clamp(1.55rem,5.5vw,3.6rem)] md:leading-none">
                {market.name}
              </h2>
